...
// waveform dump
initial begin
    $dumpfile("multiport_waveform.vcd");
    $dumpvars(0, multiport_memory_tb);
end
...
initial begin
    ...
    $fdisplay(report_file,"Architecture  : multiport");
