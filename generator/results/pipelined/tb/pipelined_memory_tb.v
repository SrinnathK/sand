...
// waveform dump
initial begin
    $dumpfile("pipelined_waveform.vcd");
    $dumpvars(0, pipelined_memory_tb);
end
...
initial begin
    ...
    $fdisplay(report_file,"Architecture  : pipelined");
