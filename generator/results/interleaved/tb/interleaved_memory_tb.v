...
// waveform dump
initial begin
    $dumpfile("interleaved_waveform.vcd");
    $dumpvars(0, interleaved_memory_tb);
end
...
initial begin
    ...
    $fdisplay(report_file,"Architecture  : interleaved");
